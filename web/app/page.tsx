...
export default function Home() {
  ...
  const syncGmail = async () => {
    ...
    try {
      ...
      const body = await response.json() as { started?: boolean; imported?: number; error?: { message?: string } };
