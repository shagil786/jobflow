...
public class DeterministicMessageIntentClassifier implements MessageIntentClassifier {
    ...
    private static final List<Rule> RULES = List.of(
        ...
        rule(MessageIntent.ASSESSMENT_INVITATION, 0.92, "\\b(?:coding|technical|online) assessment\\b", DirectionPolicy.INBOUND_ONLY),
        rule(MessageIntent.ASSESSMENT_INVITATION, 0.86, "\\bcomplete (?:the|your) assessment\\b", DirectionPolicy.INBOUND_ONLY),
