...
public class AiDraftApplication {
  public static void main(String[] args) { SpringApplication.run(AiDraftApplication.class, args); }
  ...
  static class ServiceInfoController {
    ...
    ServiceInfo info(@RequestHeader(value = "X-Internal-Service-Key", required = false) String provided) {
      ...
      return new ServiceInfo("ai-draft-service", "reviewable classifications and unsent drafts", "ready");
    }
  }
